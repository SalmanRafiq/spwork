              ...
              <div class="row">
                <div class="col-md-12 col-xs-12">
                  ...
                  <div class="right_content">
                    <a class="btn btn-lg upgrade_btn" href="http://plugin.creatix9.co.uk/plugin_identifier_pro.zip">Upgrade Now!
                    </a>
                  </div>	
                </div>
              </div>
                              ...
                              <div class="table_wrapper">
                                <div class="height_100_per">
                                  ...
                                  <?php
                                    ...
                                    ?> 
                                    <span  id="<?php
                                        echo $item['no'] . '_ajax_loader'; ?>" class="d-none"><img src="<?php
                                        echo plugin_dir_url(__FILE__) . 'images/ajax-loader.gif'; ?>"></span>
                                          <i id="<?php echo $item['no']; ?>" class="cross_icon plugin_iu"  
                                          data-toggle="tooltip" data-placement="top" title="Install Now"
                                          onclick="mm_get_plugins(this.id,this); " enabled><i class="fas fa-times"></i></i>
                                    <?php
                                    } ?>
                            ...
                            <div class="table_wrapper">
                              <div class="height_100_per">
                                ...
                                <?php
                                  if (!in_array($item['install'], apply_filters('active_plugins', get_option('active_plugins')))) {                                        
                                ?>    
                                    <p class="text-center  status_not_active nowrap_text">Not Active                                    
                                    </p>
                                ...
                                ?>     
                                    ...
                                    <p class="text-center status_active">Active                                    
                                    </p>
...
function install_plugin()
{
	...
	<script type="text/javascript">
            ...
            var my_ajaxurl = '<?php
            echo admin_url('../wp-content/plugins/plugin_identifier/ajax.php', 'relative'); ?>';
